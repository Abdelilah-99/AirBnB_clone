...
class BaseModel:
    ...
    def to_dict(self):
        ...
        created_at_formatted = {"created_at": self.created_at.isoformat() if isinstance(self.created_at, datetime) else self.created_at}
        updated_at_formatted = {"updated_at": self.updated_at.isoformat() if isinstance(self.updated_at, datetime) else self.updated_at}
